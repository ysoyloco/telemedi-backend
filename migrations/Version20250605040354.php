 ...
 */
final class Version20250605040354 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE agents (id INT AUTO_INCREMENT NOT NULL, full_name VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, default_availability_pattern JSON DEFAULT NULL COMMENT '(DC2Type:json)', is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_9596AB6EE7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE queues (id INT AUTO_INCREMENT NOT NULL, queue_name VARCHAR(255) NOT NULL, priority INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_CFCA0296FB7336F0 (queue_name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE agent_skills (queue_id INT NOT NULL, agent_id INT NOT NULL, INDEX IDX_8BD64156477B5BAE (queue_id), INDEX IDX_8BD641563414710B (agent_id), PRIMARY KEY(queue_id, agent_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE agent_activity_log ADD CONSTRAINT FK_8B4A798C3414710B FOREIGN KEY (agent_id) REFERENCES agents (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE agent_activity_log ADD CONSTRAINT FK_8B4A798C477B5BAE FOREIGN KEY (queue_id) REFERENCES queues (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE agent_availability_exceptions ADD CONSTRAINT FK_9D10C6883414710B FOREIGN KEY (agent_id) REFERENCES agents (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE queue_load_trends ADD CONSTRAINT FK_E80F7A4E477B5BAE FOREIGN KEY (queue_id) REFERENCES queues (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE agent_skills ADD CONSTRAINT FK_8BD64156477B5BAE FOREIGN KEY (queue_id) REFERENCES queues (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE agent_skills ADD CONSTRAINT FK_8BD641563414710B FOREIGN KEY (agent_id) REFERENCES agents (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE schedules ADD CONSTRAINT FK_313BDC8E3414710B FOREIGN KEY (agent_id) REFERENCES agents (id)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE agent_skills DROP FOREIGN KEY FK_8BD64156477B5BAE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE agent_skills DROP FOREIGN KEY FK_8BD641563414710B
        SQL);
        $this->addSql(<<<'SQL'
